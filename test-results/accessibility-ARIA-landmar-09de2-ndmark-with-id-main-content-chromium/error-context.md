...
- Name: accessibility.spec.ts >> ARIA landmarks >> bookmarklet page has main landmark with id=main-content
...
Error: strict mode violation: locator('#main-content') resolved to 2 elements:
    1) <div id="main-content">…</div> aka locator('#main-content').first()
    2) <main id="main-content">…</main> aka getByText('Capture from anywhereDrag the')
